...
register_shutdown_function(function () {
    ...
    echo '<style>
        ...
        .err-icon{width:72px;height:72px;background:var(--color-danger-bg);color:#b91c1c;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:32px;margin:0 auto 18px}
        h1{color:var(--text-dark);font-size:1.25rem;margin:0 0 10px}
        p{color:var(--text-muted);font-size:.9rem;line-height:1.6;margin:0 0 22px}
        .err-detail{background:var(--color-danger-bg);color:#991b1b;padding:10px 14px;border-radius:8px;font-family:monospace;font-size:.78rem;margin:14px 0;text-align:left;border:1px solid var(--color-danger-border);word-break:break-all}
    ...
    echo '<a class="err-btn" href="' . htmlspecialchars($home) . '">लगिन पृष्ठमा फर्किनुहोस्</a>';
    echo '</div></body></html>';
});
