            ...
            <div class="card-body p-0">
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <?php echo adminEmptyRow(7, $__t('कुनै सेवा छैन।', 'No services found.'), '', 'concierge-bell'); ?>
                            <?php elseif (empty($servicesLive)): ?>
                            <?php echo adminEmptyRow(7, $__t('सक्रिय सेवा छैन। अभिलेख हेर्नुहोस्।', 'No active services.'), '', 'check-circle'); ?>
                            <?php endif; ?>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <?php echo adminEmptyRow(7, $__t('अभिलेखमा कुनै सेवा छैन।', 'No archived services.'), '', 'folder-open'); ?>
                            <?php endif; ?>
