        ...
        <main class="main-content">
            ...
            <header class="admin-header admin-header--compact">
                ...
                <div class="header-right admin-header-actions">
                    ...
                    <!-- Dark mode toggle -->
                    <button type="button" class="admin-header-icon" id="topbarDarkModeToggle"
                            title="<?php echo $adminT('डार्क मोड', 'Dark Mode'); ?>"
                            aria-label="<?php echo $adminT('थिम टगल', 'Toggle theme'); ?>"
