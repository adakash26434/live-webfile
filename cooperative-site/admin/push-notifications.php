    ...
    <div class="card" style="border-radius:16px;">
        <div class="card-body" style="display:flex;gap:14px;align-items:center;padding:18px 20px;">
            ...
            <div>
                ...
                <div class="text-muted" style="font-size:.8rem;font-weight:600;">कुल Subscriptions</div>
            </div>
        </div>
    </div>
    <div class="card" style="border-radius:16px;">
        <div class="card-body" style="display:flex;gap:14px;align-items:center;padding:18px 20px;">
            ...
            <div>
                ...
                <div class="text-muted" style="font-size:.8rem;font-weight:600;">Push-enabled सदस्यहरू</div>
            </div>
        </div>
    </div>
    <div class="card" style="border-radius:16px;">
    ...
    <div class="card-body" style="padding:20px;">
        <form method="POST" id="pushForm">
            ...
            <div class="mb-3">
                ...
                ?></textarea>
                <div class="text-muted" style="font-size:.74rem;margin-top:3px;">अधिकतम 250 अक्षर</div>
            </div>
...
<div class="card" style="border-radius:16px;">
    ...
    <div style="max-height:520px;overflow-y:auto;">
        ...
        <div class="text-muted" style="text-align:center;padding:40px;font-size:.85rem;">
