            ...
            <div class="card-body p-0">
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <?php echo adminEmptyRow(6, 'कुनै डाउनलोड छैन।', '', 'download'); ?>
                            <?php elseif (empty($downloadsLive)): ?>
                            <?php echo adminEmptyRow(6, 'सक्रिय फाइल छैन। अभिलेख हेर्नुहोस्।', '', 'check-circle'); ?>
                            <?php endif; ?>
    ...
    <?php echo csrfField(); ?>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <?php echo adminEmptyRow(6, 'अभिलेखमा कुनै फाइल छैन।', '', 'folder-open'); ?>
                            <?php endif; ?>
