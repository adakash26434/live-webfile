        ...
        <div class="card admin-table-card svc-flat-top-card">
            ...
            <div class="card-body p-0">
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <?php if (empty($links)): ?>
                            <?php echo adminEmptyRow(7, 'कुनै लिंक छैन।', '', 'link'); ?>
                            <?php elseif (empty($linksLive)): ?>
                            <?php echo adminEmptyRow(7, 'सक्रिय लिंक छैन। अभिलेख हेर्नुहोस्।', '', 'check-circle'); ?>
                            <?php endif; ?>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <?php echo adminEmptyRow(7, 'अभिलेखमा कुनै लिंक छैन।', '', 'folder-open'); ?>
                            <?php endif; ?>
