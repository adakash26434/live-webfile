...
try { $centers = $db->query("SELECT id, name, name_np, address, phone, email, province, opening_hours, map_url, is_main_branch, is_active, display_order, created_at FROM service_centers ORDER BY display_order, name")->fetchAll(); }
            ...
            <div class="card-body p-0">
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <?php echo adminEmptyRow(6, 'कुनै शाखा छैन। माथिको "नयाँ थप्नुहोस्" बटन थिच्नुहोस्।', '', 'map-marker-alt'); ?>
                            <?php elseif (empty($centersLive)): ?>
                            <?php echo adminEmptyRow(6, 'सक्रिय शाखा छैन। अभिलेख हेर्नुहोस्।', '', 'check-circle'); ?>
                            <?php endif; ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <form method="POST" style="display:inline" data-confirm="के तपाईं यो शाखा मेटाउन निश्चित हुनुहुन्छ?">
    <?php echo csrfField(); ?>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <?php echo adminEmptyRow(6, 'अभिलेखमा कुनै शाखा छैन।', '', 'folder-open'); ?>
                            <?php endif; ?>
