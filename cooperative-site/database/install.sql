...
CREATE TABLE IF NOT EXISTS notification_log (
    ...
    INDEX idx_notif_member_status (member_id, status)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
...
CREATE TABLE IF NOT EXISTS member_password_reset_requests (
    ...
    INDEX idx_mpwr_status (status),
    INDEX idx_mpwr_status_member (member_id, status),
    INDEX idx_mpwr_expires (requested_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
