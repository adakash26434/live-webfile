...
function ensurePublicTables(): void {
    ...
    try {
        ...
        /* ── 2026-06-12 Performance: Add missing status indexes ── */
        $addIndex('member_password_reset_requests', 'idx_mpwr_status', 'status');
        $addIndex('member_password_reset_requests', 'idx_mpwr_status_member', 'member_id, status');
        $addIndex('member_password_reset_requests', 'idx_mpwr_expires', 'expires_at');
        $addIndex('notification_log', 'idx_notif_status', 'status');
        $addIndex('notification_log', 'idx_notif_member_status', 'member_id, status');
        $addIndex('admin_activity_log', 'idx_activity_admin', 'admin_id');
        $addIndex('admin_activity_log', 'idx_activity_created', 'created_at');
